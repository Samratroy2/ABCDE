...
// Optional: auth middleware if you want /me route
...
// Helper functions
const readDoctors = () =>
  fs.existsSync(dummyDoctorFile) ? JSON.parse(fs.readFileSync(dummyDoctorFile, 'utf-8')) : [];
...
// Optional: get logged-in doctor profile
